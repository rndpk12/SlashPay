...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Move, spend and receive money around the world with Slash Pay."
			},
			{
				name: "author",
				content: "Slash Pay"
...
var Route$1 = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "Send, spend and receive money internationally with Slash Pay."
		},
		{
			property: "og:title",
			content: "Slash Pay: The international account"
		},
		{
			property: "og:description",
			content: "Send, spend and receive money internationally with Slash Pay."
